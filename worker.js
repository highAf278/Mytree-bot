    ...
    options: [
      {
        ...
        options: [
          ...
          { type: 3, name: '🦋 Butterfly Swarm', value: "butterfly_swarm" },
          { type: 3, name: '🌈 Rainbow Dream', value: "rainbow_dream" },
          { type: 3, name: '⭐ Starfall', value: "starfall" },
          { type: 3, name: '🕸️ Spiderweb', value: "spiderweb" },
          { type: 3, name: '🖤 Gothic Lace', value: "gothic_lace" },
          { type: 3, name: '🥀 Crimson Velvet', value: "crimson_velvet" },
          { type: 3, name: '👑 Royal Gold', value: "royal_gold" },
          { type: 3, name: '💠 Diamond Palace', value: "diamond_palace" },
          { type: 3, name: '🥂 Champagne', value: "champagne" },
          { type: 3, name: '💜 Purple Royalty', value: "purple_royalty" },
          { type: 3, name: '☢️ Toxic Green', value: "toxic_green" },
      ...
      },
      {
        ...
        options: [
          ...
          { type: 3, name: '🔥 Inferno', value: "inferno" },
          { type: 3, name: '💚 Green Glow', value: "green_glow" },
          { type: 3, name: '🍭 Candy Rush', value: "candy_rush" },
          { type: 3, name: '🌌 Cosmic', value: "cosmic" },
          { type: 3, name: '🎆 Firework', value: "firework" },
          { type: 3, name: '🩸 Royal Blood', value: "royal_blood" },
          { type: 3, name: '🪄 Enchanted', value: "enchanted" },
          { type: 3, name: '👑 Royal Purple', value: "royal_purple" },
          { type: 3, name: '🦋 Butterflies', value: "butterflies" },
          { type: 3, name: '🖤 Shadow', value: "shadow" },
